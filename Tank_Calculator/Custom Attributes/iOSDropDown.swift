...
open class DropDown : UITextField{
    ...
    @IBInspectable public var rowBackgroundColor: UIColor = .darkGray
    ...
    func setupUI () {
        ...
        arrow = Arrow(origin: CGPoint(x: center.x - arrowSize - 15,y: center.y - arrowSize/2),size: arrowSize)
    ...
    public func showList() {
        ...
        UIView.animate(withDuration: 0.9,
                       ...
                       animations: { () -> Void in
                        ...
                        self.table.frame = CGRect(x: self.frame.minX,y: self.frame.maxY+5,width: self.frame.width,height: self.tableheightX)
                        self.table.alpha = 1
...
extension DropDown: UITableViewDelegate {
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 0,
                       animations: { () -> Void in tableView.cellForRow(at: indexPath)?.alpha = 1.0
                        tableView.cellForRow(at: indexPath)?.backgroundColor = self.selectedRowColor} ,completion: { (didFinish) -> Void in
